/* Harnais de validation — Devils du New Jersey (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'NEWJERSEY',
  taille: 24,
  echantillon: {nom: 'Morgan Frost', salaire: 5950000, ct: 1, ov: 82},
  masseSousContrat: 47575000,
  nbSousContrat: 9,
  dateSecours: '8 juillet 2026',
  nbEchus: 15,
  nbBackups: 0,
  masseTotale: 106100000
};
...
(async () => {
  ...
  W.localStorage.removeItem('njd_resignatures_v1');
  W.localStorage.removeItem('njd_transac_v1');
